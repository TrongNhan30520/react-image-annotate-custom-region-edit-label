...
export default (function (_ref) {
  var regions = _ref.regions,
    ...
    pointDistancePrecision =
      _ref$pointDistancePre === void 0 ? 0 : _ref$pointDistancePre,
    ...
    RegionEditLabel =
      _ref$RegionEditLabel === void 0 ? null : _ref$RegionEditLabel,
  ...
  var innerMousePos = mat.applyToPoint(
  ...
  useLayoutEffect(function () {
    ...
    context.transform.apply(
      context,
      _toConsumableArray(mat.clone().inverse().toArray())
    )
      ...
      var _loop = function _loop() {
        ...
        switch (region.type) {
          ...
          case "polygon": {
            ...
            try {
              for (
                var _iterator2 = region.points[Symbol.iterator](), _step2;
              ...
              maskImages.current[region.src].onload = function () {
                ...
                for (var i = 0; i < imgData.data.length; i += 4) {
                  var _imgData$data$slice = imgData.data.slice(i, i + 4),
                    _imgData$data$slice2 = _slicedToArray(
                      _imgData$data$slice,
                      4
                    ),
  ...
  var zoomIn = function zoomIn(direction, point) {
    var _ref2 = [point.x, point.y],
      ...
      my = _ref2[1]
    var scale =
      typeof direction === "object" ? direction.to / mat.a : 1 + 0.2 * direction // NOTE: We're mutating mat here
    ...
    onMouseUp: function onMouseUp(e) {
      ...
      if (zoomStart) {
        ...
        if (
          ...
          var scale = Math.min(
            (_zoomEnd.x - zoomStart.x) / _iw2,
            (_zoomEnd.y - zoomStart.y) / _ih2
          )
              ...
              .map(function (r2) {
                ...
                return React.createElement(
                  ...
                  React.createElement("path", {
                    d: "M"
                      .concat(pr1.x + pr1.w / 2, ",")
                      .concat(pr1.y + pr1.h / 2, " L")
                      .concat(pr2.x + pr2.w / 2, ",")
                      .concat(pr2.y + pr2.h / 2),
                  }),
                  React.createElement(
                    "text",
                    {
